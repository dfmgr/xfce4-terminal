...
# @@File             :  install.sh
# @@Description      :  Install configurations for xfce4-terminal
...
__run_post_install() {
  ...
  cp -Rf "$APPDIR/colorschemes/." "$HOME/.local/share/xfce4/terminal/colorschemes/"
